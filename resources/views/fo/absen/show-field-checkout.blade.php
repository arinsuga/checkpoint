...
<div class="row">
  <div class="col-sm-12">
    ...
    <div class="box full-width-sm">
      <img id="imageViewer" src="{{ Arins\Facades\Filex::image($viewModel->data->attend->checkout_image) }}" alt="">
    </div>
  </div>
</div>
  ...
  <div class="col-md-12">
    ...
    <div class="form-group">
      ...
      <div class="form-control" style="border-top:none;border-left:none;border-right:none;">
        {{ $viewModel->data->attend->checkout_time }}
      </div>
    </div>
  </div>
</div>
  ...
  <div class="col-md-12">
    ...
    <div class="form-group">
      ...
      <div style="border-top:none;border-left:none;border-right:none;border-bottom: 1px solid #CED4DA">
        {{ $viewModel->data->attend->checkout_address }}
      </div>
    </div>
  </div>
</div>
  ...
  <div class="col-md-12">
      ...
      <div class="form-group">
        ...
        <div style="min-height: 120px;border-top:none;border-left:none;border-right:none;border-bottom: 1px solid #CED4DA">
          {{ $viewModel->data->attend->checkout_description }}
        </div>
      </div>
  </div>
</div>
